"""Add server-side integrity monitoring columns to hosts (Phase 1 B2)

Revision ID: b1c2d3e4f5a6
Revises: a7b8c9d0e1f2
Create Date: 2026-06-13

Adds heartbeat-gap alarm state so the portal can detect a host whose daemon
has gone silent and raise exactly one alert per ok->silent transition.
"""
